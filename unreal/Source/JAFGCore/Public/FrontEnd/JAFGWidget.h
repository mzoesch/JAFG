 ...
 */
struct JAFGCORE_API FMyPassedData
{
...
public:
    ...
    UPROPERTY(BlueprintReadOnly, Category = "JAFG|Common")
...
protected:
     ...
     */
    UFUNCTION(BlueprintImplementableEvent, Category = "JAFG|Common", meta = (AllowPrivateAccess = "true"))
