...
//     auto ExecuteCommand(UChatComponentImpl* Owner, const FText& StdIn, CommandReturnCode& OutReturnCode, FString& OutResponse) const -> void;
//     auto ExecuteCommand(UChatComponentImpl* Owner, const FServerCommand& Command, const TArray<FString>& Args, CommandReturnCode& OutReturnCode, FString& OutResponse) const -> void;
//
// protected:
//
//     virtual void InitializeAllCommands(void);
//
//     UChatComponentImpl* GetTargetBasedOnArgs(const TArray<FString>& Args, CommandReturnCode& OutReturnCode, const int32 Index = 0) const;
//
// private:
//
...
//     auto OnShowReadOnlyPlayerInventoryCommand(SERVER_COMMAND_SIG) const -> void;
// };
