...
// }
//
// void UServerCommandSubsystem::ExecuteCommand(UChatComponentImpl* Owner, const FText& StdIn, CommandReturnCode& OutReturnCode, FString& OutResponse) const
// {
//     TArray<FString> Args;
...
// }
//
// void UServerCommandSubsystem::ExecuteCommand(UChatComponentImpl* Owner, const FServerCommand& Command, const TArray<FString>& Args, CommandReturnCode& OutReturnCode, FString& OutResponse) const
// {
...
// }
//
// UChatComponentImpl* UServerCommandSubsystem::GetTargetBasedOnArgs(const TArray<FString>& Args, CommandReturnCode& OutReturnCode, const int32 Index /* = 0 */) const
// {
...
//
//     return Target ? Target->GetComponentByClass<UChatComponentImpl>() : nullptr;
// }
//
...
// {
//     AWorldCharacter* Target = Cast<AWorldCharacter>( Cast<AController>(Owner->GetOwner() )->GetCharacter());
//
//     if (Target == nullptr)
//     {
...
//             check( PlayerController )
//
//             OutResponse += FString::Printf(TEXT("%s, "), *PlayerController->GetComponentByClass<UChatComponentImpl>()->GetPlayerDisplayName());
//
//             continue;
//         }
//
...
// {
//     const UChatComponentImpl* Target = this->GetTargetBasedOnArgs(InArgs, OutReturnCode);
//
