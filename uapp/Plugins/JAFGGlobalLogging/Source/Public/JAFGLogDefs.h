...
DECLARE_LOG_CATEGORY_EXTERN(LogFontSubsystem, Log, All)
...
DECLARE_LOG_CATEGORY_EXTERN(LogModificationUBTEditorTool, Log, All)
DECLARE_LOG_CATEGORY_EXTERN(LogModSubsystem, Log, All)
DECLARE_LOG_CATEGORY_EXTERN(LogMyNetwork, Log, All)
DECLARE_LOG_CATEGORY_EXTERN(LogRecipeSystem, Log, All)
...
DECLARE_LOG_CATEGORY_EXTERN(LogUnitTests, Log, All)
...
inline DEFINE_LOG_CATEGORY(LogFontSubsystem)
...
inline DEFINE_LOG_CATEGORY(LogModificationUBTEditorTool)
inline DEFINE_LOG_CATEGORY(LogModSubsystem)
inline DEFINE_LOG_CATEGORY(LogMyNetwork)
inline DEFINE_LOG_CATEGORY(LogRecipeSystem)
...
inline DEFINE_LOG_CATEGORY(LogUnitTests)
